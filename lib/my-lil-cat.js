...
module.exports = function () {
	...
	_createClass(Canvas, [{
		...
		value: function background(color) {
			if (typeof color == 'number') this.el.style.background = 'rgb(' + color + ',' + color + ',' + color + ')';else if (color instanceof Array) this.el.style.background = 'rgb(' + color[0] + ',' + color[1] + ',' + color[2] + ')';
		}
	}]);
